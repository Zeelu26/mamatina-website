...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (orderError) {
      console.error("Failed to determine gallery photo order:", orderError);
    ...
    console.error("Unexpected gallery photo POST error:", error);
...
export async function PATCH(req: Request) {
  ...
  try {
    ...
    if (Array.isArray(body.order)) {
      ...
      if (failed?.error) {
        console.error("Failed to reorder gallery photos:", failed.error);
    ...
    console.error("Unexpected gallery photo PATCH error:", error);
...
export async function DELETE(req: Request) {
  ...
  if (findError) {
    console.error("Failed to find gallery photo:", findError);
  ...
  if (deleteError) {
    console.error("Failed to delete gallery photo:", deleteError);
